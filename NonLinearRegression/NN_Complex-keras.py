...
if __name__ == '__main__':
    ...
    model_path = "nn_complex_keras/nn_complex.h5"
    model_weights_path = "nn_complex_keras/nn_complex_weights.h5"
    ...
    model_summary_path = "nn_complex_keras/nn_complex_summary.txt"
