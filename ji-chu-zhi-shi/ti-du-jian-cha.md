...
其中， 表示$$f(x)$$的n阶导数，等号后的多项式称为函数$$f(x)$$在$$x_0$$处的泰勒展开式，剩余的$$R_n(x)$$是泰勒公式的余项，是$$(x-x_0)^n$$的高阶无穷小。
...
$$f(x+h) = f(2+0.001) = (2+0.001)^2 + 3 \times (2+0.001) =10.007001$$ $$f(x-h) = f(2-0.001) = (2-0.001)^2 + 3 \times (2-0.001) =9.993001$$ $${f(x+h)-f(x-h) \over 2h}={10.007001-9.993001 \over 2 \times 0.001}=7 \tag{10}$$
